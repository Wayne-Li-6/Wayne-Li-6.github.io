...
class AnimatedName extends React.Component {
    ...
    introAnimation() {
        ...
        .add({
            targets: '.re1',
            d: [
                { value: "M 510 612 h 4 v 80 h -4 Z" },
                { value: "M 220 612 h 580 v 80 h -580 Z" },
            ],
            easing: 'easeOutCirc',
            duration: 2800,
            loop: false,
        ...
        .add({
            ...
            d: [
                { value: "M 510 612 h 4 v 80 h -4 Z" },
                { value: "M 800 612 h 4 v 80 h -4 Z" },
            ],
            easing: 'easeOutCirc',
            duration: 2800,
            loop: false,
        ...
        .add({
            ...
            d: [
                { value: "M 510 612 h 4 v 80 h -4 Z" },
                { value: "M 220 612 h 4 v 80 h -4 Z" },
            ],
            easing: 'easeOutCirc',
            duration: 2800,
            loop: false,
...
{/* 
                ...
                <path className="re1" d="M 510 1200 h 4 v 80 h -4 Z"/> */}
                
                <clipPath id="show-name">
                    <path className="re1" d="M 510 1200 h 4 v 80 h -4 Z"/>
                </clipPath>
                <path id="re2" d="M 512 1200 h 4 v 80 h -4 Z"/>
                <path id="re3" d="M 512 1200 h 4 v 80 h -4 Z"/>
                <text className="hd1" x="300" y="682" clip-path="url(#show-name)">WAYNE</text>
            </svg>
        )
    }
}
